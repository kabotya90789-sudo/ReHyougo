...
public class Pin2 implements Serializable {
	...
	public Pin2(int id, String lat, String lon, int pinGrow) {
		this.id = id;
		this.lat = lat;
		this.lon = lon;
	...
	public Pin2(String userId, String name, String address, String url,
	...
	// 引数あり（id, userId, name, address, url, lat, lon, imageUrl, info, tags, createdDate）
			// → 編集用
			public Pin2(int id, String userId, String name, String address, String url,
					String lat, String lon, String imageUrl, String info, 
					Date createdDate) {
				this.id = id;
				this.userId = userId;
